"""One seeded skirmish. Throw a javelin, close with a sword, or yield.

Numbers are placeholder so the loop is playable and testable. They are not
combat design.
"""
...
def make_default_foe() -> Character:
    return Character(name="raider", vigor=8, skill=4)
